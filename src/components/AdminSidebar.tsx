    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-white/10 space-y-2">
          <div className="flex items-center justify-between px-4 py-2.5 rounded-lg text-xs font-semibold text-white/70">
            <span>Site Teması</span>
            <div className="text-white">
              <ThemeToggle adminMode={true} />
            </div>
          </div>
          <Link
            href="/"
